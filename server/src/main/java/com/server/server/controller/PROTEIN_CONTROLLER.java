...
//		String cookie  = headers.getFirst(HttpHeaders.AUTHORIZATION);
...
Map<String, String> map = new HashMap<String, String>();
	String id_json2="";
	   ...
	   if(key.equals("authorization")){
		 id_json2=value;
		System.out.println("Auth Value" + value);
	    }           
 //map.put(key, value);
        }
 ...
 protein_repo.iterateJsonObject(key_value_list,id_json2,connection,key_value_combinator_list);            
	...
	public String readCookie(HttpServletRequest request) {
	 ...
	 @CrossOrigin(origins = "http://localhost:3000", allowedHeaders = "*")
		...
		System.out.println("Body" + region);
...
/*        String determineRegion ="";
        for(int i =0 ; i<region.size(); i++) {
	        String loopRegion = region.get(i).asText();
	        determineRegion= determineRegion+loopRegion;
        }
        
        char[] charArray = determineRegion.toCharArray();
        Arrays.sort(charArray);
        String selectedRegion = String.valueOf(charArray);
