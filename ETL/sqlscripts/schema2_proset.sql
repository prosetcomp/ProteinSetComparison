...
CREATE TABLE `GO_TERMS` (
  ...
  CONSTRAINT `fk_goterms_namespace` FOREIGN KEY (`NAMESPACE`) REFERENCES `NAMESPACE` (`NAMESPACE`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PATHWAY_HIERARCHY` (
  ...
  CONSTRAINT `fk_path_child` FOREIGN KEY (`CHILD_ID`) REFERENCES `PATHWAY` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_path_parent` FOREIGN KEY (`PARENT_ID`) REFERENCES `PATHWAY` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PMID2AUTHOR` (
  ...
  CONSTRAINT `fk_pmid2author_pmid` FOREIGN KEY (`PUBLICATION_PMID`) REFERENCES `PUBLICATION` (`PMID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PRIMARY2SECONDARY` (
  ...
  CONSTRAINT `fk_prisec_acc` FOREIGN KEY (`PRIMARY_ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_DISEASE` (
  ...
  CONSTRAINT `fk_prot_disease_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_prot_disease_mim` FOREIGN KEY (`MIM`) REFERENCES `DISEASE` (`MIM`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_DOMAIN` (
  ...
  CONSTRAINT `fk_domain` FOREIGN KEY (`DOMAIN`) REFERENCES `DOMAIN` (`PFAM`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_GENE` (
  ...
  CONSTRAINT `fk_prot_gene_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_ONTOLOGY` (
  ...
  CONSTRAINT `fk_prot_go_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_prot_go_id` FOREIGN KEY (`ONTOLOGY`) REFERENCES `GO_TERMS` (`TERM_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_PATHWAY` (
  ...
  CONSTRAINT `fk_prot_path_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_prot_path_id` FOREIGN KEY (`PATHWAY`) REFERENCES `PATHWAY` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_PDB` (
  ...
  CONSTRAINT `fk_prot_pdb_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROTEIN_PUBLICATION` (
  ...
  CONSTRAINT `fk_prot_pub_acc` FOREIGN KEY (`ACCESSION`) REFERENCES `PROTEIN` (`ACCESSION`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_prot_pub_pmid` FOREIGN KEY (`PMID`) REFERENCES `PUBLICATION` (`PMID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TAXON_HIERARCHY` (
  ...
  CONSTRAINT `fk_tax_child` FOREIGN KEY (`CHILD`) REFERENCES `TAXON` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_tax_parent` FOREIGN KEY (`PARENT`) REFERENCES `TAXON` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TERM_RELATIONS` (
  ...
  CONSTRAINT `fk_go_id` FOREIGN KEY (`TERM_ID`) REFERENCES `GO_TERMS` (`TERM_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_go_isa` FOREIGN KEY (`IS_A`) REFERENCES `GO_TERMS` (`TERM_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET @sDBank = CONCAT('SELECT COMPID,IDURL,NAME,SYN,DEF,ACTION FROM DRUGBANK INNER JOIN ',@DBank,' ON DRUGBANK.COMPID=',@DBank,'.CID;');
...
-- Dump completed on 2021-06-10 15:11:20
